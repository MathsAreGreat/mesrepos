...
# v = t.replace("embed.html", "tracks-v1/index.fmp4.m3u8")
# a = t.replace("embed.html", "tracks-a1/index.fmp4.m3u8")

# uris = [v.replace("index.fmp4.m3u8", "init.hls.fmp4")]
# r = sess.get(v)
# r = m3u8.loads(r.text)
# uris += [
#     urljoin(v, element["uri"])
#     for element in r.data["segments"]
# ]

# fn = f"/home/mohamed/Videos/TS/Items/beINAR2.ts"
