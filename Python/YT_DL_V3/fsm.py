...
from fnc import channelize, stablize, download_audio
...
cs = {
    ...
    "PLd2bItOIVSNnJ42x9WsGGOcDFYRRy2X5q": "safari",
    "PLd2bItOIVSNlAR1S34zRHOGjgg8ywDWkl": "Bayt al asrar",
...
with ThreadPoolExecutor(2) as executor:
    executor.map(download_audio, datas)
